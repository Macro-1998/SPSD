...
class ConfigParser:
  ...
  def __init__(self, args, options=''):
    ...
    # copy key scripts into exp folder 
    work_dir = os.curdir
    src_files = ['model/HiEMMT.py', 'model/TxtBert.py', 'model/VidBert.py', 'model/loss.py', 'trainer/trainer.py', 'train.py']
    if not os.path.exists(os.path.join(work_dir,'exps', exper_name, 'scripts')):
      os.makedirs(os.path.join(work_dir,'exps', exper_name, 'scripts'))
    for src_file in src_files:
      src_path = os.path.join(work_dir, src_file)
      tgt_path = os.path.join(work_dir,'exps', exper_name, 'scripts', os.path.basename(src_file))
